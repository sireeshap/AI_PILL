...
# AI Pills Stop Script for Podman
# This script stops all AI Pills services running with Podman

echo "🛑 Stopping AI Pills (Podman)..."
...
# Stop MongoDB container with Podman
...
podman ps -a | grep ai-pills | awk '{print $1}' | xargs podman rm -f 2>/dev/null || true

echo -e "${GREEN}✅ All AI Pills services stopped successfully!${NC}"
